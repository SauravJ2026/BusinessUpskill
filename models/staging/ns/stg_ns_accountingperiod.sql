...
{#
  Model    : stg_ns_accountingperiod
  Layer    : staging (Silver)  ->  BUI_SAURAV_JHA_DB.SILVER
  Grain    : 1 row per ACCOUNTINGPERIOD
...
renamed AS (
    ...
    SELECT
        ...
        CLOSED                                                                     AS IS_CLOSED,
        TRY_TO_TIMESTAMP_NTZ(CLOSEDONDATE)                                         AS CLOSED_ON_TS_ORIGINAL,
        CONVERT_TIMEZONE('America/Los_Angeles','UTC', TRY_TO_TIMESTAMP_NTZ(CLOSEDONDATE)) AS CLOSED_ON_TS_UTC,
